...
setup(  
        ...
        install_requires= ['NumPy >= 1.17.0', 'SciPy >= 1.6.3', 'pandas >= 1.2.4', 'tensorflow >= 1.15', 'torch >= 1.7'],
        setup_requires= ['NumPy >= 1.17.0', 'SciPy >= 1.6.3', 'pandas >= 1.2.4', 'tensorflow >= 1.15', 'torch >= 1.7'],
